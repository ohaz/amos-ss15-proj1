  ...
  return function Lohnsteuer2013() {
    ...
    this.MST5_6 = function () {
      ...
      if (this.ZZX.compareTo(BigDecimalConst.valueOf(26441)) == 1) {
        ...
        if (this.ZZX.compareTo(BigDecimalConst.valueOf(9550)) == 1) {
          this.VERGL = this.ST;
          this.ZX = BigDecimalConst.valueOf(9550);

          this.UP5_6();
          this.HOCH = (this.ST.add((this.ZZX
              .subtract(BigDecimalConst.valueOf(9550)))
            .multiply(BigDecimalConst.valueOf(0.42))))
            .setScale(0, BigDecimalConst.ROUND_DOWN);
    ...
    this.UPTAB13 = function () {

      if (this.X.compareTo(BigDecimalConst.valueOf(8131)) == -1) {
