    ...
    registerSuite({
        ...
        setup: function () {
            return this.remote
                ...
                .findById('username')
                    .click()
                    .type('test_user' + Math.floor(Math.random() * (9999 - 100 + 1)) + 100) // not the best way to generate a test user - but it works
                    .end()
                .findById('email')
                    .click()
                    .type('email@' + (Math.floor(Math.random() * (9999 - 100 + 1)) + 100) + '.de')
                    .end()
                .findById('password')
                    .click()
                    .type('password')
